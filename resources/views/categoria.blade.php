...
@section('content')
    <main>
        <div class="display-4 color-black d-flex justify-content-center text-center mt-3 color-fondo mb-0">
        ...
        <div class="container d-flex flex-wrap py-3 justify-content-center px-0" id="cont_productos">
            @foreach ($productos as $producto)
                <div class="catalogo d-flex flex-column py-0 mb-3 mr-0 mx-3">
                    <a href="/{{$categoria}}/info/{{ $producto->id }}" class="overflow-hidden d-flex justify-content-center align-items-center">
